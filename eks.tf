...
resource "aws_eks_cluster" "toyeglobal_cluster" {
  ...
  vpc_config {
    subnet_ids = [aws_subnet.toyeglobal_subnet1.id, aws_subnet.toyeglobal_subnet2.id,  aws_subnet.toyeglobal_subnet3.id, aws_subnet.toyeglobal_subnet4.id]
  }
}
...
resource "aws_eks_node_group" "toyeglobal_node_group" {
  ...
  subnet_ids      = [aws_subnet.toyeglobal_subnet3.id, aws_subnet.toyeglobal_subnet4.id]
